...
output="/home/proyectos/bioinfo/fjd/BioinfoUnit/NataliaMarta_Vito/Marta_reagrupacion/"
sampleDir="${output}/trimmed"
mappedDir="${output}/mapped"
...
bowtie="${output}/scripts/bowtie_slurm.sh" 
htseq_count="${output}/scripts/htseqMiRNA_slurm.sh" 
